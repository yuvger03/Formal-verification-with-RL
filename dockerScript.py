...
for i in range(10):
    for j in range(3):
        os.system(f"docker create --name c{i},{j} --rm -it -v $HOME:$HOME -v /opt/gurobi:/opt/gurobi -w $HOME/softmax ubuntu_python3.8:1 python3 main.py {0.99 - 0.01*j} {0.05 +0.01*i}")  # This is the command that opens the docker container
